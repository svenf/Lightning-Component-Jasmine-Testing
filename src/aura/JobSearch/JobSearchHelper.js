({
    ...
    clearSearch : function(component) {
        ...
        //The below line will work in Chrome, but it will fail in IE. It is used to illustrate how components can be tested across browsers
    ...
    doTest : function(component, event) {
        ...
        $A.get("e.c:ljtResult_Event").setParams({name: "JobSearch"}).fire();
    },
